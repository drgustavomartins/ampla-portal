          ...
          {(!selectedGroup || selectedGroup === "cursos") && (
            <div className="mb-14" data-section="cursos-auth">
              <div className="mb-6 text-center">
                ...
                <h3 className="mt-3 text-xl font-bold text-[#1a1a1a]">Escolha seu tema</h3>
                <p className="mt-1 text-sm text-gray-500">Cada curso inclui teoria online completa + 10h de prática clínica presencial</p>
              </div>
                ...
                {[
                  {
                    ...
                    features: ["30 aulas teóricas online", "Casos clínicos gravados", "Materiais complementares", "Encontro ao vivo com Dr. Gustavo", "10h de prática clínica presencial"],
                    cta: "Quero Toxina",
                  ...
                  },
                  {
                    ...
                    desc: "Teoria online + prática presencial",
                    features: ["17 aulas teóricas online", "Anatomia vascular e zonas de perigo", "Materiais complementares", "Encontro ao vivo com Dr. Gustavo", "10h de prática clínica presencial"],
                  ...
                  },
                  {
                    ...
                    desc: "Teoria online + prática presencial",
                    features: ["Aulas teóricas online", "Demonstrações práticas gravadas", "Revisões científicas e artigos", "Encontro ao vivo com Dr. Gustavo", "10h de prática clínica presencial"],
                  ...
                  },
                  {
                    ...
                    desc: "Teoria online + prática presencial",
                    features: ["Aulas teóricas online", "Protocolos de aplicação detalhados", "Evidências científicas atualizadas", "Encontro ao vivo com Dr. Gustavo", "10h de prática clínica presencial"],
                  ...
                  >
                    <h3 className="text-xl font-bold text-[#1a1a1a]">{curso.title}</h3>
