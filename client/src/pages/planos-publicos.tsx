      ...
      {isNegociacao ? (
        <div className="mt-auto space-y-2">
          ...
          <a
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-green-600 py-3 font-semibold text-white transition-all hover:bg-green-500"
          >
            ...
            Solicitar vaga com o Dr. Gustavo
          </a>
        </div>
      ) : (
        <button
