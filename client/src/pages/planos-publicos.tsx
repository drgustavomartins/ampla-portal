            ...
            <div className="relative p-7 sm:p-8 xl:p-5 flex flex-col flex-1">
              ...
              <div className="mt-auto pt-4 sm:pt-6">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg sm:rounded-xl py-2.5 sm:py-3.5 text-[13px] sm:text-[14px] font-semibold tracking-wide transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:brightness-105"
                  style={{
            ...
            <div className="relative p-7 sm:p-8 xl:p-5 flex flex-col flex-1">
              ...
              <div className="mt-auto pt-4 sm:pt-6">
                <a
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg sm:rounded-xl py-2.5 sm:py-3.5 text-[13px] sm:text-[14px] font-semibold tracking-wide transition-all hover:brightness-105"
                  style={{
          ...
          >
            ...
            <div className="relative p-7 sm:p-8 xl:p-5 flex flex-col flex-1">
              ...
              <a
                ...
                className="mt-auto pt-5 sm:pt-8 flex w-full items-center justify-center gap-2 rounded-lg sm:rounded-2xl py-2.5 sm:py-4 text-[13px] sm:text-[15px] font-semibold sm:font-bold transition-all duration-200 hover:brightness-110"
