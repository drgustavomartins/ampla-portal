          ...
          >
            ...
            <div className="relative p-7 sm:p-8 xl:p-5 flex flex-col flex-1">
              ...
              <div className="mt-auto pt-4 sm:pt-6">
                ...
                >
                  Escolher meu tema <ArrowRight className="hidden sm:block h-4 w-4" />
                </a>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative p-7 sm:p-8 xl:p-5 flex flex-col flex-1">
              ...
              <a
                ...
                className="mt-auto pt-4 sm:pt-8 flex w-full items-center justify-center gap-1.5 rounded-lg sm:rounded-2xl py-2 sm:py-4 text-[12px] sm:text-[15px] font-semibold sm:font-bold transition-all duration-200 hover:brightness-110"
              ...
              >
                ...
                Quero Acompanhar <ArrowRight className="hidden sm:block h-4 w-4" />
              </a>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative p-7 sm:p-8 xl:p-5 flex flex-col flex-1">
              ...
              >
                ...
                Falar com Dr. Gustavo <ArrowRight className="hidden sm:block h-4 w-4" />
              </a>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative p-7 sm:p-8 xl:p-5 flex flex-col flex-1">
              ...
              >
                ...
                Quero o Acompanhamento Elite <ArrowRight className="hidden sm:block h-4 w-4" />
              </a>
            </div>
          </div>
