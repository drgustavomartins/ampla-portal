...
import {
  ...
  GraduationCap, Clock, Video, Edit2, Shield
} from "lucide-react";
          ...
          <Card>
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{approvedStudents.length}</p>
              </div>
            </CardContent>
          </Card>
          <Card>
          ...
          <TabsContent value="students" className="space-y-4 mt-4">
            {pendingStudents.length > 0 && (
              <div className="space-y-2">
                <h3 className="text-sm font-semibold text-orange-600 dark:text-orange-400 flex items-center gap-1.5">
                    ...
                    <Card key={s.id}>
                      <CardContent className="p-4 flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          {plan && <Badge variant="secondary" className="mt-1 text-xs">{plan.name}</Badge>}
                        </div>
                      ...
                      <CardContent className="p-3 flex items-center justify-between gap-3">
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-2 ml-5.5 mt-0.5">
                            ...
                            {lesson.videoUrl ? (
                              <Badge variant="secondary" className="text-xs">Com vídeo</Badge>
                            ) : (
