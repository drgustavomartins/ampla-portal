...
export async function registerRoutes(server: Server, app: Express) {
  ...
  // ============================================================
  // Fonte de verdade das horas: users.clinical_practice_hours.
  // Consumida por HorasPraticaObservacaoTab. Expunha nome e email de todos
  // os alunos sem autenticacao ate 17/07/2026.
