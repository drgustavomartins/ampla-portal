...
export const PLANS: Record<PlanKey, PlanConfig> = {
  ...
  plataforma_anual: {
    ...
    valorMercado: 593790,
    features: [
      "Todos os módulos do portal: Toxina, Preenchedores, Bioestimuladores, Biorregeneradores e Moduladores, Fios de PDO, IA para Clínica, Intercorrências e Método NaturalUp®",
      "Mais de 60 aulas gravadas — assista quantas vezes quiser durante os 12 meses",
      "Materiais científicos complementares",
      "Atualizações do portal incluídas durante o período de acesso",
